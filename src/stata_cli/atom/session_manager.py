#!/usr/bin/env python3
"""
Session Manager - Manages multiple Stata worker processes for CLI sessions.

This module provides session lifecycle management, request routing, and worker
health monitoring for the local Rust CLI and Python backend.
...
from .worker_process import CommandType, worker_process
...
class SessionManager:
    ...
    def execute_file(
        ...
        if log_file is None:
            ...
            log_file = os.path.join(log_dir, f"{base_name}_{session.session_id}_cli.log")
